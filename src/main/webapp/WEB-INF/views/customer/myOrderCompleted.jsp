...
<body>
    ...
    <div class="container">
		...
		<c:forEach var="cnfOrder" items="${myOrders}">
			<section class="myOrderContainer">
				<div class="row">
					...
					<div class="col-sm"><a class="btn btn-primary" href="/customer/address?shno=${cnfOrder.sourceAddHouseNo}&dhno=${cnfOrder.destAddHouseNo}">View Address</a></div>
					<div class="col-sm"><a class="btn btn-primary" href="/customer/itemlist/${cnfOrder.orderId}">Items List</a></div>
				</div>
			</section>
		</c:forEach>
    </div>
