	...
	<div class="container emp-profile">
		<form method="post">
			<div class="row">
				...
				<div class="col-md-2">
					<a href="/serviceprovider/edit-profile" class="btn btn-warning">Edit Profile</a>
				</div>
			</div>
			<div class="row">
					...
					<div class="tab-content profile-tab" id="myTabContent">
						<div class="tab-pane fade show active" id="home" role="tabpanel"
							...
							<div class="row">
								...
								<div class="col-md-6">
									<p>${serviceProvider.serviceProviderType}</p>
								</div>
							</div>
						</div>
						<div class="tab-pane fade" id="profile" role="tabpanel"
							...
							<div class="row">
								...
								<div class="col-md-6">
									<p>${serviceProvider.address.houseNo}</p>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
								...
								<div class="col-md-6">
									<p>${serviceProvider.address.apartmentOrHomeName}</p>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
								...
								<div class="col-md-6">
									<p>${serviceProvider.address.state}</p>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
								...
								<div class="col-md-6">
									<p>${serviceProvider.address.district}</p>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
								...
								<div class="col-md-6">
									<p>${serviceProvider.address.cityName}</p>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
								...
								<div class="col-md-6">
									<p>${serviceProvider.address.policeStation}</p>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
								...
								<div class="col-md-6">
									<p>${serviceProvider.address.landMark}</p>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<p>${serviceProvider.address.pin}</p>
								</div>
